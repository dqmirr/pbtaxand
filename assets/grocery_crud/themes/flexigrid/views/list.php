		...
		<tr  <?php if($num_row % 2 == 1){?>class="erow"<?php }?>>
			...
			<td align="left" width='20%'>
				<div class='tools'>				
					...
					?>
							<a href="<?php echo $action_url; ?>" class="<?php echo $action->css_class; ?> crud-action" title="<?php echo $action->label?>" target="<?php echo $action->target == ''? '_self' : $action->target;?>"><?php 
